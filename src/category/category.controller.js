...
var CategoryController = function () {
        ...
        CategoryController_1.prototype.getCategory = function () {
            return __awaiter(this, arguments, void 0, function (query) {
                ...
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.categoryService.getCategory(query)];
                });
            });
        };
        // GET /categories/:id
        CategoryController_1.prototype.getCategoryById = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.categoryService.getCategoryById(id)];
                });
            });
        };
        // Post /categories/:id
        CategoryController_1.prototype.createCategory = function (id, category) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.categoryService.createCategory(category)];
                });
            });
        };
        // PUT /categories/:id
        CategoryController_1.prototype.updateCategory = function (id, category) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.categoryService.updateCategory(category, id)];
                });
            });
        };
    ...
    (function () {
        ...
        _getCategoryById_decorators = [(0, common_1.Get)(':id')];
        _createCategory_decorators = [(0, common_1.Post)()];
        _updateCategory_decorators = [(0, common_1.Put)(':id')];
        __esDecorate(_classThis, null, _getCategory_decorators, { kind: "method", name: "getCategory", static: false, private: false, access: { has: function (obj) { return "getCategory" in obj; }, get: function (obj) { return obj.getCategory; } }, metadata: _metadata }, null, _instanceExtraInitializers);

...
var UserController = function () {
    ...
    var UserController = _classThis = /** @class */ (function () {
        ...
        UserController_1.prototype.getUsers = function (query) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.userService.getAllUsers(query)];
                });
            });
        };
        UserController_1.prototype.getUserById = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.userService.getUserById(id)];
                });
            });
        };
        UserController_1.prototype.loginUser = function (loginUserFrm) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.userService.loginUser(loginUserFrm)];
                });
            });
        };
        UserController_1.prototype.registerUser = function (userFrm) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.userService.registerUser(userFrm)];
                });
            });
        };
    ...
    (function () {
        ...
        _getUserById_decorators = [(0, common_1.Get)('user:id')];
        _loginUser_decorators = [(0, common_1.Post)('login-user')];
        _registerUser_decorators = [(0, common_1.Post)('register-user')];
